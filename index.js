...
function addGamesToPage(games) {
  ...
  for (let i = 0; i < games.length; i++) {
    ...
    div.innerHTML = `<img src="${games[i].img}" alt="game image" class="game-img"/> <h2 class="game-name"> ${games[i].name}</h2> <p class="game-description"> ${games[i].description}</p> <p class="game-pledged"> Pledged: $${games[i].pledged}</p> <p class="game-goal"> Goal: ${games[i].goal}</p> <p class="game-backers"> Backers: ${games[i].backers}</p>`;
...
let firstGameName = document.createElement("h2");
firstGameName.innerHTML = firstGame.name;
firstGameContainer.appendChild(firstGameName);

// do the same for the runner up item
let secondGameName = document.createElement("h2");
